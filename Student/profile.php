    ...
    <table class="table table-bordered table-hover">
      <tbody>
        <tr>
          ...
          ?>
            <td rowspan="3" colspan="2" align="center"><img src="/Futuregen/Images/stu_img/<?php echo $_SESSION['Id_No'] . ".jpg" ?>" alt="Student Image" width="150px"></td>
          <?php
          } else {
          ?>
        ...
        <tr>
          ...
          <td rowspan="3">
            ...
            ?>
              <img src="/Futuregen/Images/parent_img_male/<?php echo $_SESSION['Id_No'] . ".jpg" ?>" alt="Father Image" width="150px">
            <?php
            } else {
            ?>
          ...
          <td rowspan="3">
            ...
            ?>
              <img src="/Futuregen/Images/parent_img_female/<?php echo $_SESSION['Id_No'] . ".jpg" ?>" alt="Mother Image" width="150px">
            <?php
            } else {
            ?>
